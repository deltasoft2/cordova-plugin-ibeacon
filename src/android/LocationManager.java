...
public class LocationManager extends CordovaPlugin implements BeaconConsumer {
    ...
    private void tryToRequestMarshmallowLocationPermission() {
        ...
        try {
            ...
            builder.setMessage("This app collects location data to enable 'Geo-fence based proximity alerts to Employees','For Geo-fence based Trip Closure','To measure total distance covered during the trip' and 'To notify the user if the vehicle is Overspeeding' even when the app is closed or not in use.\n This data is 'NOT' used to provide ads.”);
